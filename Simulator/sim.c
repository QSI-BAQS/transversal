...
ds_Complex ds_compare(ds_Register reg1, ds_Register reg2)
{
   int i;
   ds_Complex temp;
...
void ds_lerr(ds_Register reg, int q, int time, double p)
{
   int i, j, k;
...
void ds_lerr2(ds_Register reg, int q1, int q2, int time, double p)
{
   int i, j, k;
   double delta, alpha, beta, theta;
   ds_Complex z;
   ...
   if (time == 0) return;
    ...
    // if (p < reg.err*reg.err){    	
	   //  ds_lerr(reg, q1, time, ds_uniform()*reg.err);
	   //  ds_lerr(reg, q2, time, ds_uniform()*reg.err);
    // } else if (p < (1-(1-reg.err)*(1-reg.err))/2){
	   //  ds_lerr(reg, q1, time, ds_uniform()*reg.err);
    // } else if (p < (1-(1-reg.err)*(1-reg.err))){
	   //  ds_lerr(reg, q2, time, ds_uniform()*reg.err);
    // }
   ...
   if (reg.err > 0) {      
      ...
      else if (p < 2*reg.err/15) {
      	ds_Z(reg, q1, 0);
      	printf("Zerr = %d \n", q1);
      }
      else if (p < 3*reg.err/15) {
      	ds_XZ(reg, q1, 0);
      	printf("XZerr = %d \n", q1);
      }
      else if (p < 4*reg.err/15) {
      	ds_X(reg, q2, 0);
      	printf("Xerr = %d \n", q2);
      }
      else if (p < 5*reg.err/15) {
      	ds_X(reg, q2, 0);
      	printf("Xerr = %d \n", q2);
      	ds_X(reg, q1, 0);
      	printf("Xerr = %d \n", q1);
      }
      else if (p < 6*reg.err/15) {
      	ds_X(reg, q2, 0);
      	printf("Xerr = %d \n", q2);
      	ds_Z(reg, q1, 0);
      	printf("Zerr = %d \n", q1);
      }
      else if (p < 7*reg.err/15) {
      	ds_X(reg, q2, 0);
      	printf("Xerr = %d \n", q2);
      	ds_XZ(reg, q1, 0);
      	printf("XZerr = %d \n", q1);
      }
      else if (p < 8*reg.err/15) {
      	ds_Z(reg, q2, 0);
      	printf("Zerr = %d \n", q2);
      }
      else if (p < 9*reg.err/15) {
      	ds_Z(reg, q2, 0);
      	printf("Zerr = %d \n", q2);
      	ds_X(reg, q1, 0);
      	printf("Xerr = %d \n", q1);
      }
      else if (p < 10*reg.err/15) {
      	ds_Z(reg, q2, 0);
      	printf("Zerr = %d \n", q2);
      	ds_Z(reg, q1, 0);
      	printf("Zerr = %d \n", q1);
      }
      else if (p < 11*reg.err/15) {
      	ds_Z(reg, q2, 0);
      	printf("Zerr = %d \n", q2);
      	ds_XZ(reg, q1, 0);
      	printf("XZerr = %d \n", q1);
      }
      else if (p < 12*reg.err/15) {
      	ds_XZ(reg, q2, 0);
      	printf("XZerr = %d \n", q2);
      }
      else if (p < 13*reg.err/15) {
      	ds_XZ(reg, q2, 0);
      	printf("XZerr = %d \n", q2);
      	ds_X(reg, q1, 0);
      	printf("Xerr = %d \n", q1);
      }
      else if (p < 14*reg.err/15) {
      	ds_XZ(reg, q2, 0);
      	printf("XZerr = %d \n", q2);
      	ds_Z(reg, q1, 0);
      	printf("Zerr = %d \n", q1);
